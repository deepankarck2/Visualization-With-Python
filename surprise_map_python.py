...
app.layout = html.Div([
    ...
    html.H3("Effect of Precipitaiton on Countries", style={'text-align': 'left', 'color': colors['text2']}),
        ...
        html.Div([
         ...
         html.Div(children='''
            Showing The Effects of Flood in Differnt Crops after a dangerous flood in 2016.
        ''',
            style={
            #
